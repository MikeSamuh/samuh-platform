...
// completed (video opened, walkthrough finished, selection made, etc). A
// step's tasks must all complete before the next step unlocks; backwards is
// always allowed. Scheduling with Samuh is offered on every step but never
// required. Every step opens with a guided walkthrough of that step.
